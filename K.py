...
print "       x=\"5\""
print "       y=\"32\""
print "       style=\"font-size:12px;text-align:center;text-anchor:middle;font-family:Bitstream Vera Sans;\">K</tspan></text>"


ln = str(float(int((math.log(math.pi)*SCALE/3 + OFFSET)*10 )/10.))
h1 = "38"; h2 = "59"; h3 = "35"
print "  <text style=\"font-size:12px;fill:#000000;\">"
print "      <tspan"
print "       x=\"" + str(ln) + "\""
...
ln = str(float(int((math.log(math.e)*SCALE/3 + OFFSET)*10 )/10.))
h1 = "38"; h2 = "59"; h3 = "35"
print "  <text style=\"font-size:12px;fill:#000000;\">"
print "      <tspan"
print "       x=\"" + str(ln) + "\""
...
for i in range(100,200,2):
    ln = str(float(int((math.log(i/100.)*SCALE/3 + OFFSET)*10 )/10.))
    if int((i/10)*10) == i:
        h1 = "38"; h2 = "59"; h3 = "35"
        if int((i/100)*100) == i:
            print "  <text style=\"font-size:12px;fill:#000000;\">"
